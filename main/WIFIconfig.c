...
void iniciarWiFi(){
	...
	esp_event_loop_init( ManejadorEventos, NULL );			//se especifica la función donde se manejan los eventos del wifi
	wifi_init_config_t cfg = WIFI_INIT_CONFIG_DEFAULT();	//se establece la configuración por defecto del wifi
	esp_wifi_init( &cfg );
	esp_wifi_set_storage( WIFI_STORAGE_RAM );

	// existen dos formas de configurar el WiFi:
	// como una estación, usando " .sta ", o como un punto de acceso, usando " .ap ".
